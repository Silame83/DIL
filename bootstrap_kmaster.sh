...
kubeadm init --apiserver-advertise-address=10.100.100.10 --pod-network-cidr=192.168.0.0/16 >> /root/kubeinit.log 2>/dev/null
...
#echo "[EXTRA TASK] Deploy flannel network"
